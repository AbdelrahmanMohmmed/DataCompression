# -*- coding: utf-8 -*-
"""assignment_compression_session5.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1HGnxmhYv9PoXtOYFwGQ3H0fFGqIr0Z3J

im willing to write clean code with comments and handle exceptions :)
this is my code no use for any ai tools
inspired parts of the code from the section
"""
